...
static struct omap_opp_def __initdata omap36xx_opp_def_list[] = {
	...
	OMAP_OPP_DEF("mpu", true,  1350000000, 1485000),
        /* MPU OPP9 */
	OMAP_OPP_DEF("mpu", false,  1400000000, 1570000),
	...
	OMAP_OPP_DEF("l3_main", true, 200000000, 1162500),
        /* L3 OPP3 - MAX */
	OMAP_OPP_DEF("l3_main", false, 300000000, 1185000),
	...
	/* DSP OPP8 */
	OMAP_OPP_DEF("iva", true, 890000000, 1485000),
        /* DSP OPP9 */
	OMAP_OPP_DEF("iva", false, 900000000, 1570000),
};
